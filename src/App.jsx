    ...
    chapters: [
      {
        ...
        lessons: [
          ...
          { 
            ...
            duration: '圖文', 
            type: 'article', 
            imageUrl: 'https://i.ibb.co/FkPjM03z/model-map.jpg', 
            content: '觀念來自於轉折天機-主力籌碼流動的思維，每個型裡它的籌碼會那樣跑動就是有它的用意。\n\n第1型：ABC鋸齒型\n第2型：平台型\n第3型：三角收斂型\n第4型：二低一新高\n第5型：暗處吸籌型\n\n🎯 核心觀念：\n第 1~4 型都有一波突破下降趨勢或橫盤區，走一波出量的突破上漲。會有幫左邊籌碼沉澱區「解套籌碼」而「吸籌」的效果。之後進入洗盤中，會有量縮、放量的來回加倉洗籌行為。\n\n⏰ 週期與漲幅：\n• 若在【日線】看到：週期可能較小，漲幅差不多是 30% ~ 50%。\n• 若在【週線】看到：就有 50% 或 1倍以上的「中長期」級別架構。\n\n🔍 族群性與有效度：\n模型主要由「量堆」和「價的波動」所構築。若族群類股也有模型，就表示它的股票裡有這種型出現，就會更有族群性的漲勢力道。我們可以「從個股，再去反推類股看」，加強模型的有效度。\n\n⚠️ 發動特徵：\n• 暗處吸籌型 (第5型)：在熱門股票回檔沉寂一陣後常看到，要去分辨這個型裡的內容，通常「第三個底」出現就可以留意天機 K 了。\n• 第 4 跟 第 5 型：在發動時易有急漲段出現的機會，所以第 5 型也常會出現一字型態的樣子。' 
          },
